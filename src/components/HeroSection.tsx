...
const HeroSection = () => {
    return (
        <>
            <div className="bg-brand-secondary absolute top-0 left-0 flex h-screen w-full items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="flex flex-col items-center gap-4 sm:flex-row">
                        ...
                        >
                            ...
                            <span className="font-semibold transition-colors duration-200 group-hover:text-white/70">
                                Download CV
                            </span>
                        </a>
                    </div>
